// GENERATED by scripts/mirror-import.ts from HH-Studio/simple-site-builder:lib/import/motionExtract.ts
...
//      every agency "cloneable" template ships, which is most of what
